...
global.ownername = process.env.OWNER_NAME === undefined ? "YoUsSef Al SoLtAn" : process.env.OWNER_NAME
let fake = process.env.OWNER_NUMBER === undefined ? '201227179105' : process.env.OWNER_NUMBER
global.owner = [`${fake}`]
global.ownernumber = [`${fake}`]
global.premium = [`${fake}`]
global.anticall = process.env.ANTICALL === undefined ? 'true' : process.env.ANTICALL
global.packname = process.env.PACK_NAME === undefined ? 'BOT - AL SOLTAN' : process.env.PACK_NAME
global.author = process.env.STICKER_AUTHOR_NAME === undefined ? '201227179105' : process.env.STICKER_AUTHOR_NAME
